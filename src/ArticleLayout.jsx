 ...
 * Just add this as a className to your article tag
 */
export const articleStyles = `
  prose prose-lg dark:prose-invert max-w-none
  prose-headings:font-bold prose-headings:tracking-tight
  prose-h1:text-4xl prose-h1:mb-6 prose-h1:text-zinc-900 dark:prose-h1:text-zinc-50
  prose-h2:text-3xl prose-h2:mt-16 prose-h2:mb-6 prose-h2:pb-4 prose-h2:border-b-2 prose-h2:border-emerald-200 dark:prose-h2:border-emerald-900 prose-h2:text-zinc-900 dark:prose-h2:text-zinc-50
  ...
  prose-code:text-emerald-700 dark:prose-code:text-emerald-300 prose-code:bg-emerald-50 dark:prose-code:bg-emerald-900/20 prose-code:px-2 prose-code:py-0.5 prose-code:rounded prose-code:font-medium prose-code:text-base prose-code:before:content-none prose-code:after:content-none
`;

export default function ArticleWrapper({ children, className = "" }) {
    return (
        <div className={`min-h-screen bg-gradient-to-b from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 ${className}`}>
